        ...
        <ul class="navbar-nav ml-lg-auto">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-item">
             ...
             <div class="dropdown-item">
              <a class="" href="{{url('/admin/ChnPass')}}" style="text-decoration: none; color: #000;">
                <div class="sender">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="layoutsSubmenu">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/addstudent')}}"><i class="fas fa-user-plus"></i>&nbsp; &nbsp;Add Category</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/allstudent')}}"><i class="far fa-user"></i>&nbsp; &nbsp;All Category</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#layoutsSubmenu1" aria-expanded="false" aria-controls="layoutsSubmenu">
                <i class="fas fa-user-graduate"></i>
              ...
              <div class="collapse" id="layoutsSubmenu1">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/addstudent')}}"><i class="fas fa-user-plus"></i>&nbsp; &nbsp;Add Product</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/allstudent')}}"><i class="far fa-user"></i>&nbsp; &nbsp;All Product</a>
                  </li>
                </ul>
              </div>
            </li>
